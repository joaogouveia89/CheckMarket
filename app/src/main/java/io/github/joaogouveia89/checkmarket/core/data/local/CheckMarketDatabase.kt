...
import io.github.joaogouveia89.checkmarket.core.data.local.entity.InstantConverter
...
@TypeConverters(MarketItemCategoryConverter::class, InstantConverter::class)
@Database(
